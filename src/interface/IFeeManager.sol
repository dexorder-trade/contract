...
interface IFeeManager {
    ...
    // Emitted when a new VaultLogic is proposed by the upgrader account
    event FeesProposed(FeeSchedule indexed fees, uint32 indexed activationTime);

    // Emitted when a new VaultLogic contract has fulfilled its waiting period and become the new default implementation
